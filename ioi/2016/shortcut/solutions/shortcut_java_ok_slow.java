...
class shortcut {
    ...
    public void solve(int testNumber, shortcut_java_ok_slow.InputReader in, shortcut_java_ok_slow.OutputWriter out) {
        int n = in.readInt();
        int c = in.readInt();
        int[] l = shortcut_java_ok_slow.IOUtils.readIntArray(in, n - 1);
        int[] d = shortcut_java_ok_slow.IOUtils.readIntArray(in, n);
    ...
    public long find_shortcut(int n, int[] l, int[] d, int c) {
        ...
        shortcut_java_ok_slow.IntList list = new shortcut_java_ok_slow.IntArrayList();
        for (int i = 0; i < n; i++) {
            if (viable[i]) {
                list.add(i);
            }
        ...
        long left = shortcut_java_ok_slow.ArrayUtils.maxElement(d);
        long right = shortcut_java_ok_slow.ArrayUtils.sumArray(l) + 2 * shortcut_java_ok_slow.ArrayUtils.maxElement(d);
        while (left < right) {
 ...
 */
public class shortcut_java_ok_slow {
    public static void main(String[] args) {
        new shortcut_java_ok_slow().run();
    }
