...
void program_pulibot()
{
    ...
    instruct({LAST1, 1, ANY, ANY, ANY}, CLEAR, 'H');
    instruct({LAST1, ANY, 1, ANY, ANY}, CLEAR, 'H');
    instruct({LAST1, ANY, ANY, 1, ANY}, CLEAR, 'H');
    instruct({LAST1, ANY, ANY, ANY, 1}, CLEAR, 'H');

    instruct({LAST2, 1, ANY, ANY, ANY}, CLEAR, 'H');
    instruct({LAST2, ANY, 1, ANY, ANY}, CLEAR, 'H');
    instruct({LAST2, ANY, ANY, 1, ANY}, CLEAR, 'H');
    instruct({LAST2, ANY, ANY, ANY, 1}, CLEAR, 'H');

    instruct({LAST3, 1, ANY, ANY, ANY}, CLEAR, 'H');
    instruct({LAST3, ANY, 1, ANY, ANY}, CLEAR, 'H');
    instruct({LAST3, ANY, ANY, 1, ANY}, CLEAR, 'H');
    instruct({LAST3, ANY, ANY, ANY, 1}, CLEAR, 'H');
