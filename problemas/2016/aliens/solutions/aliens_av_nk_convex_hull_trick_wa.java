...
public class aliens_av_nk_convex_hull_trick_wa {
    ...
    public static void main(String[] args) throws IOException {
        new aliens_av_nk_convex_hull_trick_wa().run();
    }
    ...
    void run() {
        ...
        long ans = new aliens_av_nk_convex_hull_trick_wa().take_photos(n, m, k, r, c);
