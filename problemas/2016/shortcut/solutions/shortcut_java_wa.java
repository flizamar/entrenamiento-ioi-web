...
class shortcut {
    ...
    public void solve(int testNumber, shortcut_java_wa.InputReader in, shortcut_java_wa.OutputWriter out) {
        int n = in.readInt();
        int c = in.readInt();
        int[] l = shortcut_java_wa.IOUtils.readIntArray(in, n - 1);
        int[] d = shortcut_java_wa.IOUtils.readIntArray(in, n);
    ...
    public long find_shortcut(int n, int[] l, int[] d, int c) {
        ...
        shortcut_java_wa.IntList list = new shortcut_java_wa.IntArrayList();
        for (int i = 0; i < n; i++) {
            if (viable[i]) {
                list.add(i);
            }
        ...
        long left = shortcut_java_wa.ArrayUtils.maxElement(d);
        long right = shortcut_java_wa.ArrayUtils.sumArray(l) + 2 * shortcut_java_wa.ArrayUtils.maxElement(d);
        while (left < right) {
